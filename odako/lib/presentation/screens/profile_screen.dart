    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: Theme.of(
          context,
        ).colorScheme.surface, // Consistent dialog background
          ...
          TextButton(
            ...
            child: Text(
              ...
              style: Theme.of(context).textTheme.labelLarge?.copyWith(
                color: Theme.of(
                  context,
                ).colorScheme.primary, // Primary color for action buttons
                fontWeight: FontWeight.bold,
              ),
            ),
          ),
        ...
        Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage(
                'lib/presentation/assets/na_background_1.png',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Icon(
                                    Icons.stars,
                                    color: theme.colorScheme.secondary,
                                  ), // Added an icon for achievements
                                ],
                              ),
                              const SizedBox(height: 16), // Increased spacing
                              badges.isEmpty
                                        ...
                                        children: badges.map((badge) {
                                          ...
                                          return GestureDetector(
                                            ...
                                            child: Opacity(
                                              ...
                                              child: Container(
                                                width:
                                                    100, // Slightly wider badge container
                                                padding:
                                                ...
                                                decoration: BoxDecoration(
                                                  color: unlocked
                                                      ? theme
                                                            ...
                                                            .withValues(
                                                              alpha: 50 / 255,
                                                            ) // More prominent unlocked color
                                                      : theme
                                                            .colorScheme
                                                            .surfaceContainerHighest, // Different color for locked
                                                  borderRadius:
                                                  ...
                                                  border: Border.all(
                                                    color: unlocked
                                                        ? theme
                                                              .colorScheme
                                                              .primary // Primary for unlocked border
                                                        : theme
                                                              .colorScheme
                                                              .outline, // Outline for locked border
                                                    width: 2,
                                                  ),
                                                  boxShadow: [
                                                      ...
                                                      style: theme
                                                          ...
                                                          ?.copyWith(
                                                            ...
                                                            color: unlocked
                                                                ? theme
                                                                      .colorScheme
                                                                      .onSurface // OnSurface for unlocked
                                                                : theme
                                                                      .colorScheme
                                                                      .onSurface
                                                                      .withValues(
                  ...
                  GestureDetector(
                    onTap: () => _logout(context), // 🔁 Tıklama işlevi
                    child: Container(
                      width: double.infinity,
                      height: 50,
                      decoration: BoxDecoration(
                        image: const DecorationImage(
                          image: AssetImage(
                            'lib/presentation/assets/signout.png',
                          ), // 🖼 PNG arka plan
                          fit: BoxFit.cover,
                        ),
                        borderRadius: BorderRadius.circular(12),

...
class MainMenuScreen extends StatelessWidget {
  ...
  Future<String> _fetchUsername() async {
    try {
      ...
      return (username != null && username.toString().isNotEmpty) ? username : 'User';
    } catch (e) {
  ...
  Widget _buildHighPriorityTask(BuildContext context) {
    final user = FirebaseAuth.instance.currentUser;
    if (user == null) {
  ...
  Widget _buildOpenChatSection() => const OpenChatSection();
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildHighPriorityTask(context),
                  const SizedBox(height: 24),
                  _buildOpenChatSection(),
                ],
              ),
            ),
          ),
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  fixedSize: const Size(125.0, 45.0),
